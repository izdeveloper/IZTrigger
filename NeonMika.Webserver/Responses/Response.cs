...
namespace NeonMika.Webserver.Responses
{
    ...
    abstract public class Response : IDisposable
    {
        ...
        public void Send404_NotFound(Socket Client)
        {
            ...
            string data = "<html><body><head><title>Lidar Trigger Webserver is sorry</title></head><h1>NeonMika.Webserver is sorry!</h1><h2>The file or webmethod you were looking for was not found</h2></body></html>";
